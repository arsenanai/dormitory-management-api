        ...
        <div class="content">
            ...
            <div class="payment-info">
                ...
                @if( $payment->date_from && $payment->date_to )
					<p><strong>Period:</strong> {{ $payment->date_from->format( 'M d, Y' ) }} –
						{{ $payment->date_to->format( 'M d, Y' ) }}</p>
				@endif
            </div>
            @if( ! empty( $adminEmail ) )
				<p>If you have questions, please <a href="mailto:{{ $adminEmail }}"
						style="color: #2f3459; font-weight: 600;">contact your dormitory administration</a>.</p>
			@else
