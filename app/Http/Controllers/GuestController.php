...
class GuestController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'identification_type'     => 'nullable|string|in:passport,national_id,drivers_license,other|max:255',
            'identification_number'   => 'nullable|string|max:255',
            'emergency_contact_name'  => 'nullable|string|max:255',
            'emergency_contact_phone' => 'nullable|string|max:255',
            'reminder'                => 'nullable|string',
            'status'                  => 'nullable|in:pending,active,passive',
        ]);
    ...
    public function update(Request $request, $id)
    {
        $validated = $request->validate([
            ...
            // 'payment_status' => 'sometimes|in:pending,paid,cancelled', // payment disabled
            'bed_id'         => 'required|integer|exists:beds,id',
            'total_amount'   => 'nullable|numeric|min:0', // payment amount disabled for now
            'notes'          => 'sometimes|string',
            'host_name'               => 'sometimes|nullable|string|max:255',
            'host_contact'            => 'sometimes|nullable|string|max:255',
            'identification_type'     => 'sometimes|nullable|string|in:passport,national_id,drivers_license,other|max:255',
            ...
            'status'                  => 'sometimes|nullable|in:pending,active,passive',
        ]);

        $result = $this->guestService->updateGuest($id, $validated);
