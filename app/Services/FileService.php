...
class FileService
{
    ...
    /**
     * Upload a base64 encoded file to a specific folder
     *
     ...
     */
    public function uploadBase64File(string $base64Data, string $folder, ?string $filename = null): ?string
    {
        try {
            ...
            if (preg_match('/^data:(\w+\/\w+);base64,/', $base64Data, $type)) {
                ...
                // Assume it's raw base64 and guess extension or use default
                $extension = 'jpg';
            }
