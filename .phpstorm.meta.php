...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','services.postmark.token','services.resend.key','services.ses.key',
...
'sanctum.csrf-cookie',
'file.download','payments.store','users.index','users.store','users.show','users.update',
'users.destroy','guests.index','guests.store','guests.show','guests.update',
'guests.destroy','payments.index','payments.show',
'payments.update','payments.destroy','students.index',
...
'emails.password.reset','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403','laravel-exceptions::404',
