...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\PaymentGateway\PaymentGatewayInterface' => \App\Services\PaymentGateway\BankCheckGateway::class,
    ...
    override(\config(), map([
            ...
            'app.spa_url' => 'string',
            'app.autocomplete_limit' => 'integer',
            'app.admin_email' => 'string',
            'app.admin_password' => 'string',
            'app.sudo_email' => 'string',
            'app.sudo_password' => 'string',
            ...
            'cache.prefix' => 'string',
            'constants.APP_VERSION' => 'string',
            'constants.GUEST_DEFAULT_PASSWORD' => 'string',
            'cors.paths' => 'array',
            ...
            'filesystems.links./Users/rsa/lab/testcrm/crm-back/public/storage' => 'string',
            ...
            'mail_events.user.registered.mailable' => 'string',
            'mail_events.user.registered.recipient' => 'string',
            'mail_events.payment.status_changed.mailable' => 'string',
            'mail_events.payment.status_changed.recipient' => 'string',
            'mail_events.user.status_changed.mailable' => 'string',
            'mail_events.user.status_changed.recipient' => 'string',
            'mail_events.message.sent.mailable' => 'string',
            'mail_events.message.sent.recipient' => 'string',
            'mail_templates.types.user_registered' => 'string',
            'mail_templates.types.payment_status_changed' => 'string',
            'mail_templates.types.user_status_changed' => 'string',
            'mail_templates.types.message_sent' => 'string',
            'mail_templates.placeholders.user_registered.app_name' => 'string',
            'mail_templates.placeholders.user_registered.admin_email' => 'string',
            'mail_templates.placeholders.user_registered.user_name' => 'string',
            'mail_templates.placeholders.user_registered.user_email' => 'string',
            'mail_templates.placeholders.user_registered.year' => 'string',
            'mail_templates.placeholders.payment_status_changed.app_name' => 'string',
            'mail_templates.placeholders.payment_status_changed.admin_email' => 'string',
            'mail_templates.placeholders.payment_status_changed.user_name' => 'string',
            'mail_templates.placeholders.payment_status_changed.user_email' => 'string',
            'mail_templates.placeholders.payment_status_changed.amount_formatted' => 'string',
            'mail_templates.placeholders.payment_status_changed.deal_number' => 'string',
            'mail_templates.placeholders.payment_status_changed.current_status' => 'string',
            'mail_templates.placeholders.payment_status_changed.period_from' => 'string',
            'mail_templates.placeholders.payment_status_changed.period_to' => 'string',
            'mail_templates.placeholders.payment_status_changed.year' => 'string',
            'mail_templates.placeholders.user_status_changed.app_name' => 'string',
            'mail_templates.placeholders.user_status_changed.admin_email' => 'string',
            'mail_templates.placeholders.user_status_changed.user_name' => 'string',
            'mail_templates.placeholders.user_status_changed.user_email' => 'string',
            'mail_templates.placeholders.user_status_changed.current_status' => 'string',
            'mail_templates.placeholders.user_status_changed.year' => 'string',
            'mail_templates.placeholders.message_sent.app_name' => 'string',
            'mail_templates.placeholders.message_sent.admin_email' => 'string',
            'mail_templates.placeholders.message_sent.user_name' => 'string',
            'mail_templates.placeholders.message_sent.user_email' => 'string',
            'mail_templates.placeholders.message_sent.message_title' => 'string',
            'mail_templates.placeholders.message_sent.message_content_preview' => 'string',
            'mail_templates.placeholders.message_sent.year' => 'string',
            'mail_templates.supported_locales' => 'array',
            'payment.default_gateway' => 'string',
            'payment.gateways.bank_check.name' => 'string',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.spa_url',
'app.autocomplete_limit','app.admin_email','app.admin_password','app.sudo_email','app.sudo_password',
...
'cache.prefix','constants.APP_VERSION','constants.GUEST_DEFAULT_PASSWORD','cors.paths','cors.allowed_methods',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/rsa/lab/testcrm/crm-back/public/storage','logging.default','logging.deprecations.channel',
...
'mail.markdown.extensions','mail_events.user.registered.mailable','mail_events.user.registered.recipient','mail_events.payment.status_changed.mailable','mail_events.payment.status_changed.recipient',
'mail_events.user.status_changed.mailable','mail_events.user.status_changed.recipient','mail_events.message.sent.mailable','mail_events.message.sent.recipient','mail_templates.types.user_registered',
'mail_templates.types.payment_status_changed','mail_templates.types.user_status_changed','mail_templates.types.message_sent','mail_templates.placeholders.user_registered.app_name','mail_templates.placeholders.user_registered.admin_email',
'mail_templates.placeholders.user_registered.user_name','mail_templates.placeholders.user_registered.user_email','mail_templates.placeholders.user_registered.year','mail_templates.placeholders.payment_status_changed.app_name','mail_templates.placeholders.payment_status_changed.admin_email',
'mail_templates.placeholders.payment_status_changed.user_name','mail_templates.placeholders.payment_status_changed.user_email','mail_templates.placeholders.payment_status_changed.amount_formatted','mail_templates.placeholders.payment_status_changed.deal_number','mail_templates.placeholders.payment_status_changed.current_status',
'mail_templates.placeholders.payment_status_changed.period_from','mail_templates.placeholders.payment_status_changed.period_to','mail_templates.placeholders.payment_status_changed.year','mail_templates.placeholders.user_status_changed.app_name','mail_templates.placeholders.user_status_changed.admin_email',
'mail_templates.placeholders.user_status_changed.user_name','mail_templates.placeholders.user_status_changed.user_email','mail_templates.placeholders.user_status_changed.current_status','mail_templates.placeholders.user_status_changed.year','mail_templates.placeholders.message_sent.app_name',
'mail_templates.placeholders.message_sent.admin_email','mail_templates.placeholders.message_sent.user_name','mail_templates.placeholders.message_sent.user_email','mail_templates.placeholders.message_sent.message_title','mail_templates.placeholders.message_sent.message_content_preview',
'mail_templates.placeholders.message_sent.year','mail_templates.supported_locales','payment.default_gateway','payment.gateways.bank_check.name','queue.default',
...
'sanctum.middleware.encrypt_cookies','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'guests.index','guests.store','guests.show','guests.update','guests.destroy','payments.index','payments.store','payments.show',
'payments.update','payments.destroy','payment-types.store','payment-types.show','payment-types.update',
'payment-types.destroy','transactions.index','transactions.store','transactions.show',
'transactions.update','transactions.destroy','students.index',
'students.store','students.show','students.update','students.destroy',
'regions.index','regions.store','regions.show','regions.update','regions.destroy',
'cities.index','cities.store','cities.show','cities.update','cities.destroy','admins.index','admins.store',
'admins.show','admins.update','admins.destroy','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'emails.message-sent','emails.password.reset','emails.payment-created','emails.payment-status-changed','emails.user-registered',
'emails.user-status-changed','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403','laravel-exceptions::404',
...
'validation.custom.attribute-name.rule-name','emails.user_registered.subject','emails.user_registered.title','emails.user_registered.system_name','emails.user_registered.greeting',
'emails.user_registered.body','emails.user_registered.contact_hint','emails.user_registered.footer_automated','emails.user_registered.footer_copyright',);
        registerArgumentsSet('env', 
'APP_ENV','APP_NAME','APP_DEBUG','API_PORT','APP_KEY',
'APP_URL','SPA_URL','FRONTEND_PORT','VOLUME_MOUNT','CACHE_STORE',
'SESSION_DRIVER','QUEUE_CONNECTION','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_EXTERNAL_PORT','REDIS_EXTERNAL_PORT',
'SANCTUM_STATEFUL_DOMAINS','SESSION_DOMAIN','SESSION_SECURE_COOKIE','GUEST_DEFAULT_PASSWORD','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','ADMIN_EMAIL','ADMIN_PASSWORD','SUDO_EMAIL',
'SUDO_PASSWORD','GUEST_DEFAULT_PASSWORD','SDU_API_SECRET_KEY','AUTOCOMPLETE_LIMIT',);
