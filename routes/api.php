...
use App\Http\Controllers\IinIntegrationController;
...
Route::get('/student/autocomplete', [ UserController::class, 'autocompleteStudent' ]);

// IIN Integration OTP Flow (Public access for registration)
Route::post('/iin/send-otp', [ IinIntegrationController::class, 'sendOtp' ]);
Route::post('/iin/verify-otp', [ IinIntegrationController::class, 'verifyOtp' ]);
...
Route::middleware([ 'auth:sanctum' ])->group(function () {
    ...
    Route::middleware([ 'role:student,guest' ])->group(function () {
        ...
        // Student/Guest self-service transactions
        Route::get('/my-transactions', [ TransactionController::class, 'myTransactions' ]);
        Route::post('/my-transactions', [ TransactionController::class, 'myStore' ]);
        Route::put('/my-transactions/{id}', [ TransactionController::class, 'updateMyTransaction' ]);
    });
    ...
    Route::middleware([ 'role:sudo' ])->group(function () {
        ...
        // IIN Integration Settings
        Route::get('/configurations/iin', [ ConfigurationController::class, 'getIinSettings' ]);
        Route::put('/configurations/iin', [ ConfigurationController::class, 'updateIinSettings' ]);
